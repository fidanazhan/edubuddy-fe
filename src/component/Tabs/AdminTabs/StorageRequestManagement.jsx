...
const StorageRequestScreen = () => {
    ...
    const tabs = [
        { name: t("admin:storage.request.pending"), icon: <Clock /> },
        { name: t("admin:storage.request.approved"), icon: <ThumbsUp /> },
        { name: t("admin:storage.request.rejected"), icon: <ThumbsDown /> },
    ];
    ...
    return (
        <div className="p-6">
            <div className="flex justify-between items-center mb-4">
                <h1 className="text-xl font-semibold">{t("admin:storage.request.title")}</h1>
            </div>
            ...
            {isLoading ? (
                ...
                <div>
                    ...
                    <div className="shadow-md rounded-lg overflow-hidden mt-2">
                                ...
                                <div className="ml-4 flex-1">
                                    <div className="flex items-center">
                                        <p className="text-md text-gray-800 dark:text-gray-300/80">
                                            {t("admin:storage.request.message", { name: request.requester?.name, amount: request?.amount })}
                                        </p>
                                        <EllipsisVertical
                        ...
                        {requests.length === 0 && (
                            <div className="text-center py-4 text-gray-600 dark:bg-gray-900 dark:border-gray-900">{t("admin:storage.request.not_found_message", { status: activeTab })}</div>
                        )}
                    </div>
...
export default StorageRequestScreen;