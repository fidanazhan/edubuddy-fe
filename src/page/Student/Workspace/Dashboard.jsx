  ...
  return (
    <div className="min-h-screen bg-gray-50 py-10 px-5 dark:bg-gray-800 dark:border-gray-800">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {/* text-2xl lg:text-lg font-bold mb-6 lg:mb-4 */}
        <div className="bg-white p-6 rounded-lg shadow-md flex justify-between dark:bg-gray-900 dark:border-gray-800">
          <div className=''>
            <h2 className="text-2xl lg:text-lg font-semibold mb-6 lg:mb-4 text-gray-700 dark:text-gray-300/80">{t("dashboard.widget_token")}</h2>
            {userInfo?.usedToken === undefined ? (
              ...
              <p className="text-gray-500 text-2xl lg:text-lg font-semibold mb-6 lg:mb-4">{userInfo.usedToken}</p>
            )}
          </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-md flex justify-between dark:bg-gray-900 dark:border-gray-800">
          <div className=''>
            <h2 className="text-2xl lg:text-lg font-semibold mb-6 lg:mb-4 text-gray-700 dark:text-gray-300/80">{t("dashboard.widget_storage")}</h2>
            {userInfo?.usedStorage === undefined ? (
              ...
              <p className="text-gray-500 text-2xl lg:text-lg font-semibold mb-6 lg:mb-4">{formatStorage(userInfo.usedStorage)}</p>
            )}
          </div>
